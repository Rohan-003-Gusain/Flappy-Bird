...
public class Medium extends JPanel implements ActionListener, KeyListener{
    ...
    public Medium(Main frame) {
      ...
      //  gameOverSound = new Sound(""); // Added game over sound
        ...
        stng = new Stngs(null, this, null, frame);
        ...
        butn.addActionListener(new ActionListener() {
            public void actionPerformed (ActionEvent e) {
                ...
                if (stng.isVisible()) {
                    ...
                    // Focus panel pe return karo
                    SwingUtilities.invokeLater(() -> Medium.this.requestFocusInWindow());
                }
            }
        });
        add(butn);
    ...
    public void movePipes() {
        ...
        for (int i = 0; i < pipes.size(); i += 2) { 
            ...
            int bottomLimit = bordrHeight - offSet;
    ...
    /*public void updateDifficulty() {
        if (score >= 5 && score % 5 == 0 && score > lastSppedIncreaseScroe) {
            lastSppedIncreaseScroe = (int) score;
